                            ...
                            <div id="filterDropdown"
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                                    <li class="flex items-center">
                                        <input id="apple" type="radio" value="nom" name="searchType" checked
                                    ...
                                    <li class="flex items-center">
                                        <input id="fitbit" type="radio" value="Etablissement" name="searchType"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                                        <label for="fitbit"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                            Etablissement
                                    ...
                                    <li class="flex items-center">
                                        <input id="asus" type="radio" value="promotion" name="searchType"   
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                                        <label for="asus"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                            Promotion
                            ...
                            <tbody id="list_laureat">
                                ...
                                <tr
                                    ...
                                    <th scope="row" class="px-6 py-4">
                                        <a href='profil_admin.php?email=<?= $laureat['email'] ?>'
                                            class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <img class="w-10 h-10 rounded-full"
                                                src="<?= './asset/images/' . $laureat['img'] ?>" alt="Jese image">
                                            <div class="ps-3">
