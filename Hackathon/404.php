...
<body class=" bg-gray-100 min-h-full h-full dark:bg-black flex flex-col justify-center">

    <section class="bg-white dark:bg-gray-900 min-h-full h-full">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 h-full">
            <div class="mx-auto max-w-screen-sm text-center py-auto h-full">
    ...
    <scrip src="node_modules/flowbite/dist/flowbite.min.js"></scrip>
</body>
