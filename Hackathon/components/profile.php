            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-300 dark:hover:text-white">Users</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500 dark:text-gray-400" aria-current="page">Profile</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="col-span-full xl:col-auto">
        <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            <div class="sm:flex xl:block sm:space-x-4 xl:space-x-0">
                <img class="mb-2 w-20 h-20 rounded-lg" src="/images/users/jese-leos-2x.png" alt="Jese portrait">
                <div>
        ...
        <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            <div class="flow-root">
                ...
                <ul class="flex flex-wrap mt-4">
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Brand Design</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Logo Design</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Mobile App Design</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">UI Design</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">React Developer</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Wordpress</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Sketch</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Figma</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Prototyping</li>
                    <li class="bg-green-100 dark:bg-green-200 text-green-800 text-base font-medium px-3 py-1.5 rounded-md mb-2">Database</li>
                </ul>
            </div>
        </div>
        <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
