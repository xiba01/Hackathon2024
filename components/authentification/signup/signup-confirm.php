<div class="flex items-center mx-auto md:w-[42rem] px-4 md:px-8 xl:px-0">
    <div class="w-full">
        ...
        <svg class="w-12 h-12 mb-4 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">
        ...
        <h1 class="mb-2 text-2xl font-extrabold tracking-tight text-gray-900 leding-tight dark:text-white">Tout est mis en place</h1>
        <p class="mb-4 font-light text-gray-500 dark:text-gray-400 md:mb-6">Vous avez déposé avec succès les informations de votre compte.</p>
        <div class="flex items-start mb-8">
            <div class="flex items-center h-5">
                <input id="terms" aria-describedby="terms" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800" required="">
            </div>
            <div class="ml-3 text-sm">
                <label for="terms" class="font-light text-gray-500 dark:text-gray-300">En vous inscrivant, vous créez un compte OfpptCA et vous acceptez les conditions d'utilisation d'OfpptCA. <a class="font-medium text-primary-600 dark:text-primary-500 hover:underline" href="#">Conditions d'utilisation</a> et <a class="font-medium text-primary-600 dark:text-primary-500 hover:underline" href="#">Politique de Confidentialité</a>.</label>
            </div>
        </div>
        <button type="submit" class="block w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 sm:py-3.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Confirmation d'inscription</button>
    </div>
</div>